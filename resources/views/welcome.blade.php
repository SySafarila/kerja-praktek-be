...
<div class="max-w-screen-lg mx-auto"
    ...
    <div class="p-5 py-8 lg:py-20 text-accent-4 bg-[#356F11]/75 flex flex-col gap-4">
        <h1 class="text-3xl text-center text-accent-2 uppercase font-bold">Pendaftaran Peserta Didik Baru</h1>
        <p class="text-accent-2 text-center">Kami mengundang putra terbaik Negeri untuk bergabung bersama SMA Ma’arif
            Pacet</p>

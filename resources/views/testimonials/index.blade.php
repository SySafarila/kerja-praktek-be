        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    <h1 class="m-0 text-capitalize">testimonials</h1>
                    @can('testimonials-create')
                        <a href="{{ route('admin.testimonials.create') }}" class="btn btn-sm btn-primary ml-2">Add New</a>
                    @endcan
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                        <li class="breadcrumb-item active text-capitalize">testimonials</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const buttons = [{
                ...
                action: function() {
                    startBulkDelete('{{ csrf_token() }}', '{{ route('admin.testimonials.massDestroy') }}')
                }
            }, ];

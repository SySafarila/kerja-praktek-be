        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    <h1 class="m-0 text-capitalize">extracurriculars</h1>
                    @can('extracurriculars-create')
                        <a href="{{ route('admin.extracurriculars.create') }}" class="btn btn-sm btn-primary ml-2">Add New</a>
                    @endcan
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="{{ route('admin.index') }}">Home</a></li>
                        <li class="breadcrumb-item active text-capitalize">extracurriculars</li>
                    </ol>
                </div>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            const buttons = [{
                ...
                action: function() {
                    startBulkDelete('{{ csrf_token() }}', '{{ route('admin.extracurriculars.massDestroy') }}')
                }
            }, ];
            ...
            const datatable = $('#datatable').DataTable({
                ...
                ajax: '{!! route('admin.extracurriculars.index') !!}',
                lengthMenu: [

        ...
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6 d-flex align-items-center">
                    <h1 class="m-0 text-capitalize">Daftar Buku</h1>
                    @can('elibrary-create')
                        <a href="{{ route('admin.elibrary.create') }}" class="btn btn-sm btn-primary ml-2">Add New</a>
                    @endcan
                </div>
                <div class="col-sm-6">
    ...
    <script>
        $(document).ready(function() {
            ...
            const buttons = [{
                ...
                action: function() {
                    startBulkDelete('{{ csrf_token() }}', '{{ route('admin.elibrary.massDestroy') }}')
                }
            }, ];
            ...
            const datatable = $('#datatable').DataTable({
                ...
                ajax: '{!! route('admin.elibrary.index') !!}',
                lengthMenu: [
